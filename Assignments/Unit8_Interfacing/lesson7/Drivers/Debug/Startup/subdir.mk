...
Startup/startup_stm32f103c6tx.o: ../Startup/startup_stm32f103c6tx.s
	arm-none-eabi-gcc -gdwarf-2 -mcpu=cortex-m3 -g3 -c -I"F:/learn_in_depth/embedde_System_Onlin_Diplome_Repo/Assignments/Unit8_Interfacing/New folder/Drivers/HAL/inc" -I"F:/learn_in_depth/embedde_System_Onlin_Diplome_Repo/Assignments/Unit8_Interfacing/New folder/Drivers/stm32_F103C6_drivers/inc" -I"F:/learn_in_depth/embedde_System_Onlin_Diplome_Repo/Assignments/Unit8_Interfacing/New folder/Drivers/Inc" -x assembler-with-cpp -MMD -MP -MF"Startup/startup_stm32f103c6tx.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
